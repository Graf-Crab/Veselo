...
public class DotaHeroes {
     ...
     public List<String> dotaHeroesNames = new ArrayList<>(Arrays.asList("Anti-Mage", "Axe", "Bane", "Bloodseeker", "",
             ...
             "Dazzle", "Clockwerk", "Leshrac", "Lifestealer", "Clinkz", "Omniknight", "Enchantress", "Huskar",
             "Broodmother", "Weaver", "Jakiro", "Batrider", "Chen", "Spectre", "Doom", "Ursa", "Gyrocopter", "Alchemist",
             "Invoker", "Silencer", "Lycan", "Brewmaster", "Meepo", "Treant", "Undying", "Rubick", "Disruptor",
